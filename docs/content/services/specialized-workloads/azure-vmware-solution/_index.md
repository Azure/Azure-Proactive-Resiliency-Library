...
|[AVS-3 Configure Azure Monitor Alert warning thresholds for vSAN datastore utilization](#avs-3---configure-azure-monitor-alert-warning-thresholds-for-vsan-datastore-utilization) | Monitoring | High | Verified | Yes |
...
|[AVS-19 Verify vSAN FTT configuration aligns with the cluster size](#avs-19---verify-vsan-ftt-configuration-aligns-with-the-cluster-size) | Application Resilience | High | Verified | No |
| [ERC-1 Connect your on-premises network to critical workloads in Azure through two or more ExpressRoute circuits in different peering locations](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-circuits/#erc-1---connect-your-on-premises-network-to-critical-workloads-in-azure-through-two-or-more-expressroute-circuits-in-different-peering-locations) | Availability | High | Verifiied | No
| [ERC-2 Ensure the two physical links of your ExpressRoute circuit are connected to two distinct edge devices in your network](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-circuits/#erc-2---ensure-the-two-physical-links-of-your-expressroute-circuit-are-connected-to-two-distinct-edge-devices-in-your-network) | Availability | High | Verifiied | No
| [ERC-3 Ensure both connections of an ExpressRoute circuit are configured in active-active mode](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-circuits/#erc-3---ensure-both-connections-of-an-expressroute-circuit-are-configured-in-active-active-mode) | Availability | High | Verifiied | Yes
| [ERC-4 Ensure Bidirectional Forwarding Detection is enabled and configured on customer or provider edge routing devices](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-circuits/#erc-4---ensure-bidirectional-forwarding-detection-is-enabled-and-configured-on-customer-or-provider-edge-routing-devices) | Availability | High | Verifiied | No
| [ERC-5 Configure monitoring and alerting for ExpressRoute circuits](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-circuits/#erc-5---configure-monitoring-and-alerting-for-expressroute-circuits) | Monitoring | Medium | Verifiied | No
| [ERC-6 Configure service health to receive ExpressRoute circuit maintenance notification](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-circuits/#erc-6---configure-service-health-to-receive-expressroute-circuit-maintenance-notification) | Monitoring | Medium | Verifiied | No
| [ERGW-1 Connect the ExpressRoute Gateway to two or more circuits from different peering locations for higher resiliency](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-gateway/#ergw-1---connect-the-expressroute-gateway-to-two-or-more-circuits-from-different-peering-locations-for-higher-resiliency) | Availability | High | Verified | No
| [ERGW-2 Use Zone-redundant gateway SKUs](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-gateway/#ergw-2---use-zone-redundant-gateway-skus) | Availability | High | Verified | Yes
...
| [ERGW-7 Configure customer-controlled gateway maintenance - In Preview](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-gateway/#ergw-7---configure-customer-controlled-gateway-maintenance---in-preview) | System Efficiency | Medium | Verified | No
| [ERCON-1 For Connections using ExpressRoute Direct circuits and UltraPerformance or ErGw3AZ ExpressRoute Gateways, enable FastPath to improve data path performance between your on-premises network and your virtual network](https://azure.github.io/Azure-Proactive-Resiliency-Library/services/networking/expressroute-connection/#ercon-1---for-connections-using-expressroute-direct-circuits-and-ultraperformance-or-ergw3az-expressroute-gateways-enable-fastpath-to-improve-data-path-performance-between-your-on-premises-network-and-your-virtual-network) | Networking | High | Verified | No

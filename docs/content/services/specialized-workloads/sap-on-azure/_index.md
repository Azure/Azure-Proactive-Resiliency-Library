...
| [SAP-47 - DBHANA-Pacemaker-SLES- Database Instance - Ensure the Pacemaker cluster has been setup for SAP HANA DB high availability.](#sap-47---dbhana-pacemaker-sles--database-instance---ensure-the-pacemaker-cluster-has-been-setup-for-sap-hana-db-high-availability) | Availability | High | Published | No |

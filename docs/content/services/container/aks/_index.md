...
| [AKS-3 - Enable AKS-managed Entra integration](#aks-3---disable-local-accounts)                                                                                                                         | Access & Security |  High   | Preview |         Yes         |
...
| [AKS-19 - Configure Pod replication in production applications to guarantee availability](#aks-19---configure-pod-replica-sets-in-production-applications-to-guarantee-availability)                                         |   Availability    |  High   | Preview |         No          |

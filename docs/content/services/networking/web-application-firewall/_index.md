...
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----: | :-----: | :-----------------: |
| [WAF-1 - Associate Web Application Firewall policy with Azure Application Gateway](#waf-1---associate-web-application-firewall-policy-with-azure-application-gateway)                                                                                                                          |  High  | GA |         No         |
| [WAF-2 - Associate Web Application Firewall with Azure Front Door](#waf-2---associate-web-application-firewall-with-azure-front-door)                                                                                                              |  High  | GA |         No         |
...
| [WAF-5 - Identify a blocked legitimate request for Web Application Firewall on Azure Front Door](#waf-5---identify-a-blocked-legitimate-request-for-web-application-firewall-on-azure-front-door)                                                                                                                |  High  | GA |         No         |
| [WAF-6 - Identify a blocked legitimate request for Web Application Firewall on Azure Application Gateway](#waf-6---identify-a-blocked-legitimate-request-for-web-application-firewall-on-azure-application-gateway)                                                                                                                |  High  | GA |         No         |

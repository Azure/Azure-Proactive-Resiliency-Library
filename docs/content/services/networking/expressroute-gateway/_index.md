...
| [ERGW-6 - Configure customer-controlled gateway maintenance - In Preview](#ergw-6---configure-customer-controlled-gateway-maintenance---in-preview) | Availability | High | Preview | No |
| [ERGW-7 - Avoid using ExpressRoute circuits for VNet to VNet communication](#ergw-7---avoid-using-expressroute-circuits-for-vnet-to-vnet-communication) | Networking | Medium | Preview | No |
...
### ERGW-6 - Configure customer-controlled gateway maintenance - In Preview
...
- [Configure customer-controlled gateway maintenance for ExpressRoute (Preview)](https://learn.microsoft.com/azure/expressroute/customer-controlled-gateway-maintenance)
...
### ERGW-7 - Avoid using ExpressRoute circuits for VNet to VNet communication
